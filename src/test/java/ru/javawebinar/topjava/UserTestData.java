...
public class UserTestData {
    ...
    public static final TestUser USER = new TestUser(BaseEntity.START_SEQ, "User", "user@yandex.ru", "password", 2000, true, Role.ROLE_USER);
    public static final TestUser ADMIN = new TestUser(BaseEntity.START_SEQ + 1, "Admin", "admin@gmail.com", "admin", 1500, true, Role.ROLE_ADMIN);
    ...
    public static class TestUser extends User {
        ...
        public TestUser(String name, String email, String password, Role role, Role... roles) {
            this(null, name, email, password, 2000, true, EnumSet.of(role, roles));
        }

        public TestUser(Integer id, String name, String email, String password, int caloriesPerDay, boolean enabled, Role role, Role... roles) {
